...
urlpatterns = [
    ...
    path('student/login/', auth_views.LoginView.as_view(template_name='student_login.html'), name='student_login'),
    ...
    path('add_student.html', ensure_csrf_cookie(TemplateView.as_view(template_name='add_student.html')), name='add_student'),
    path('attendance.html', ensure_csrf_cookie(TemplateView.as_view(template_name='attendance.html')), name='attendance'),
    path('marks.html', ensure_csrf_cookie(TemplateView.as_view(template_name='marks.html')), name='marks'),
    path('student_profile.html', ensure_csrf_cookie(TemplateView.as_view(template_name='student_profile.html')), name='student_profile'),
    path('edit_student.html', ensure_csrf_cookie(TemplateView.as_view(template_name='edit_student.html')), name='edit_student'),
